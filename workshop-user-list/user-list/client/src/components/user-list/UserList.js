...
import {UserActions} from '../../utils/Util';
import {UserDelete} from './UserDelete';
import {UserCreate} from './UserCreate';

export const UserList = ({users, addUser, editUser, deleteUser}) => {
...
const userCreateHandler = (e) =>{
    ...
    return (<>
          <div className="table-wrapper">
              ...
              {userAction.action == UserActions.Edit && <UserEdit user={userAction.user} onClose={closeHandler} onUserEdit={userEditHandler}/>}

              {userAction.action == UserActions.Delete && <UserDelete user={userAction.user} onClose={closeHandler} onDelete={userDeleteHandler}/>}
