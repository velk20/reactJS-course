...
const REGEXES = {
    ...
    phoneNumber: /^([+]?[\s0-9]+)?(\d{3}|[(]?[0-9]+[)])?([-]?[\s]?[0-9])+$/i,
    imageUrl: /^https?:\/\/.+\.(jpg|jpeg|png|webp|avif|gif|svg)$/i,
}
export const UserCreate = ({onClose, onUserCreate}) => {
    ...
    const submitHandler = (e) => {
        ...
        userData.address = {country, street, streetNumber, city};
                          ...
                          <div className="form-group">
                              ...
                              <div className="input-wrapper">
                                  ...
                                  <input id="email" name="email" type="text"
                                         value={values.email}
                                         onChange={changeHandler}
                                         onBlur={(e) => regexValidation(e, REGEXES.email)}/>
                              </div>
                              {errors.email &&
                          ...
                          <div className="form-group">
                              ...
                              <div className="input-wrapper">
                                  ...
                                  <input id="phoneNumber" name="phoneNumber" type="text"
                                         ...
                                         onChange={changeHandler}
                                         onBlur={(e) => regexValidation(e, REGEXES.phoneNumber)}/>
                              </div>
                              {errors.phoneNumber &&
                      ...
                      <div className="form-group long-line">
                          ...
                          <div className="input-wrapper">
                              ...
                              <input id="imageUrl" name="imageUrl" type="text"
                                     ...
                                     onChange={changeHandler}
                                     onBlur={(e) => regexValidation(e, REGEXES.imageUrl)}/>
                          </div>
                          {errors.imageUrl &&
